      ...
      <CardContent>
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100">{currentTier.name}</h3>
            ...
            <div>
              ...
              <ul className="space-y-1">
                {nextTier.benefits.slice(0, 3).map((benefit, index) => (
                  <li key={index} className="text-sm text-gray-500 dark:text-gray-500 flex items-center">
